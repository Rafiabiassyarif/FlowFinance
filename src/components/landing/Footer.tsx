  ...
  return (
    <footer className="relative pt-32 pb-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 relative z-10">
        ...
        {/* Massive CTA */}
        <div className="mb-32 text-center bg-gradient-to-b from-surface-dark to-bg-dark border border-white/10 p-12 md:p-24 rounded-[3rem] relative overflow-hidden shadow-2xl group">
          ...
          <div className="relative z-10">
            <h2 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold mb-6 text-white tracking-tight">
              {t('footer.ready')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-400 to-accent-400">{t('footer.control')}</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
               ...
               >
                 ...
                 <div className="relative px-10 py-5 bg-bg-dark rounded-2xl flex items-center justify-center gap-3 transition-all duration-300 group-hover/btn:bg-opacity-0 group-hover/btn:text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <span className="font-display font-bold text-2xl tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-brand-400 to-accent-400 ml-3">FlowFinance</span>
            </div>
            ...
            <div className="flex gap-4">
              {[Twitter, Github, Linkedin, Instagram].map((Icon, i) => (
                <a key={i} href="#" className="w-12 h-12 rounded-2xl bg-surface-dark hover:bg-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:-translate-y-1 transition-all border border-white/5 shadow-lg">
          ...
          <div>
            ...
            <ul className="space-y-4 text-base text-slate-400">
              <li><a href="#" className="hover:text-brand-400 transition-colors">{t('footer.features')}</a></li>
              <li><a href="#" className="hover:text-brand-400 transition-colors">{t('footer.analytics')}</a></li>
              <li><a href="#" className="hover:text-brand-400 transition-colors">{t('footer.security')}</a></li>
              <li><a href="#" className="hover:text-brand-400 transition-colors">{t('footer.dashboard')}</a></li>
            </ul>
          </div>

          <div>
            <h4 className="font-semibold text-white mb-6 tracking-wide text-sm">{t('footer.resources')}</h4>
            <ul className="space-y-4 text-base text-slate-400">
              <li><a href="#" className="hover:text-brand-400 transition-colors">{t('footer.docs')}</a></li>
              <li><a href="#" className="hover:text-brand-400 transition-colors">{t('footer.help')}</a></li>
              <li><a href="#" className="hover:text-brand-400 transition-colors">{t('footer.api')}</a></li>
              <li><a href="#" className="hover:text-brand-400 transition-colors">{t('footer.blog')}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-base text-slate-400">
              <li><a href="#" className="hover:text-brand-400 transition-colors">{t('footer.about')}</a></li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-500">
          ...
          <div className="flex gap-6">
            <span className="flex items-center gap-1">{t('footer.crafted')} <span className="text-red-500">♥</span> using React</span>
